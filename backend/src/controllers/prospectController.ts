...
import { enviarCorreoProspecto } from "../services/emailService";
...
export const crearProspecto = async (
  ...
  try {
    ...
    try {
      ...
      console.error(
        "⚠️ PROSPECTO GUARDADO, PERO EL CORREO FALLÓ"
      );
      console.error(
        "===================================="
      );
    ...
    // ==========================================
    // ERROR REAL DE POSTGRESQL / SERVIDOR
    // ==========================================
